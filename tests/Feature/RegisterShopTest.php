...
class RegisterShopTest extends TestCase
{
    ...
    public function testStoreWithoutAuthentication()
    {
        ...
        $response = $this->postJson('/registerShop', $data);
    ...
    public function store()
    {
        ...
        $shopData = [
            ...
            'policies_data' => $this->generatePoliciesData(),
            'refund_policy' => [
                'refund_max' => 50,
                'substitution_max' => 25,
	...
	//delete testing shop
	Shop::latest()->limit(1)->delete();
	Policy::latest()->limit(1)->delete();
