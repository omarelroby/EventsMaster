...
class ManifestController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $data['rows'] = ManifestResource::collection($items);
        $data['meta'] = [
        ...
        return $this->okApiResponse($data,__('Manifests loaded'));
    ...
    public function store(ManifestRequest $request)
    {
        try {
            ...
            return $this->createdApiResponse(new ManifestResource($item),__('Manifest loaded'));
     ...
     * @return json response
     */
    public function update($id, ManifestRequest $request)
    {
        try {
    ...
    public function show($id)
    {
        try {
            ...
            return $this->okApiResponse(new ManifestResource($item),__('ManifestResource loaded'));
        } catch (QueryException $e) {
