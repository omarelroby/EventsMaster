...
class ShipperCompanyController extends Controller
{
    ...
    public function __construct(ShipperCompanyRepository $repository)
    {
    ...
    public function index(Request $request)
    {
        ...
        $data['rows'] = ShipperResource::collection($items);
        $data['meta'] = [
        ...
        return $this->okApiResponse($data,__('shippers loaded'));
     ...
     * @return json response
     */
    public function store(ShipperCompanyRequest $request)
    {
        try {
            $item = $this->repository->store($request);
            return $this->createdApiResponse(new ShipperResource($item),__('Shipper loaded'));
     ...
     * @return json response
     */
    public function update($id, ShipperCompanyRequest $request)
    {
        try {
    ...
    public function show($id)
    {
        try {
            ...
            return $this->okApiResponse(new ShipperResource($item),__('Shipper loaded'));
        } catch (QueryException $e) {
