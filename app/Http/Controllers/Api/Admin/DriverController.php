...
class DriverController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $data['rows'] = DriverResource::collection($items);
        $data['meta'] = [
        ...
        return $this->okApiResponse($data,__('Drivers loaded'));
    ...
    public function store(DriverRequest $request)
    {
        try {
            ...
            return $this->createdApiResponse(new DriverResource($item),__('Driver loaded'));
    ...
    public function show($id)
    {
        try {
            ...
            return $this->okApiResponse(new DriverResource($item),__('Driver loaded'));
        } catch (QueryException $e) {
